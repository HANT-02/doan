...
func buildSolverOutput(
	...
	summary := SolverSummary{
		...
		SoftScore:          scoreAssignments(assignmentSlice),
	}
...
func hasConflict(variable Variable, value DomainValue, assignments map[string]PreviewAssignment) bool {
	return len(findBlockingAssignments(variable, value, assignments)) > 0
}

func findBlockingAssignments(variable Variable, value DomainValue, assignments map[string]PreviewAssignment) []PreviewAssignment {
