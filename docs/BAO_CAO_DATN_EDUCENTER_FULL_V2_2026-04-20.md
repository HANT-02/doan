...
- Hình 4.4 Luồng dữ liệu phục vụ bài toán dự báo học viên có nguy cơ học tập kém
...
- Xây dựng và đánh giá nhánh dự báo học viên có nguy cơ học tập kém bằng học máy trên dữ liệu học vụ của hệ thống.
...
| 5 | Phân tích mở rộng | Dự báo học viên có nguy cơ học tập kém bằng học máy |
...
Về mặt thực tiễn, đề tài góp phần số hóa các nghiệp vụ quan trọng của một trung tâm dạy thêm, giúp giảm thao tác thủ công, tăng khả năng truy vết dữ liệu và nâng cao hiệu quả vận hành. Về mặt học thuật, đề tài tạo ra giá trị ở việc mô hình hóa bài toán scheduling, tách lớp solver theo hướng mở rộng, benchmark nhiều thuật toán trên cùng một tập ràng buộc, đồng thời xây dựng và đánh giá một nhánh học máy để dự báo học viên có nguy cơ học tập kém trên dữ liệu học vụ của hệ thống.
...
- Xây dựng nhánh học máy bằng Python cho bài toán dự báo học viên có nguy cơ học tập kém, huấn luyện được mô hình và tích hợp kết quả vào hệ thống vận hành.
...
- Dữ liệu vận hành thực tế cho nhánh dự báo học viên có nguy cơ học tập kém hiện chưa đủ dày để thay hoàn toàn bộ dữ liệu demo trong thực nghiệm chính thức.
...
- Mở rộng dữ liệu thật và nâng chất lượng giải thích mô hình cho nhánh dự báo học viên có nguy cơ học tập kém.
