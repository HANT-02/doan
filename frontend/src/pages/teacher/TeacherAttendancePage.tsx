...
export default function TeacherAttendancePage() {
    ...
    return (
        <Stack sx={{ p: { xs: 2, md: 4 } }} spacing={3}>
            <PageHeader
                title="Điểm danh"
                subtitle="Chọn buổi học bạn phụ trách và cập nhật chuyên cần cho toàn bộ học sinh."
            />
            ...
            {selectedLessonId ? (
                <LessonAttendanceManager
                    lessonId={selectedLessonId}
                    title="Điểm danh của giáo viên"
                    subtitle="Lưu trạng thái có mặt, vắng, đi muộn hoặc có phép cho buổi học đang chọn."
                />
            ) : (
                <Alert severity="info">
